...
To generate a package of specific version, use following syntax: `-package:version` (e.g. `-sdl2:2.28.0`)
...
For example, to generate SDL2 package of version 2.28.0 and SDL2_image of default version, run:

```
./sdl2-nuget.ps1 -sdl2:2.28.0 -sdl2_image:default
```
...
**Note:** You can specify hotfix for a package (e.g. `-sdl2:2.28.0.1`), that will be used only for a NuGet version of a package.
