...
$sdl2_owners =	"username" # Packages "owner" name. Replace username with your name
$sdl2_tags = "SDL2, native, CoApp" # Tags for your packages, "SDL2, native, CoApp" by default
...
$sdl2_version = @{ "sdl2" = "2.0.8"; "sdl2_image" = "2.0.3"; "sdl2_ttf" = "2.0.14"; "sdl2_mixer" = "2.0.2"; "sdl2_net" = "2.0.1" }
...
nuget {
	nuspec {
		...
		version: " + $sdl2_version[$Package] + "$pkg_hotfix;
...
if ($pkg_hotfix -ne "" -and -not $pkg_hotfix.StartsWith("."))
{
...
Get-ChildItem -Path "../build/" -Filter "$pkg_prefix*$pkg_postfix.autopkg" | `
Foreach-Object{
